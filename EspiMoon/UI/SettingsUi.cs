...
using EspiMoon.API.Data.Comparer;
using EspiMoon.API.Routes;
...
public class SettingsUi : WindowMediatorSubscriberBase
{
    ...
    public SettingsUi(ILogger<SettingsUi> logger,
        ...
        DalamudUtilService dalamudUtilService, HttpClient httpClient) : base(logger, mediator, "Espi Moon Settings", performanceCollector)
    {
