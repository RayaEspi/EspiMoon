...
public partial class UiSharedService : DisposableMediatorSubscriberBase
{
    ...
    public void DrawCacheDirectorySetting()
    {
        ...
        using (ImRaii.Disabled(_cacheMonitor.MareWatcher != null))
        {
            ...
            {
                FileDialogManager.OpenFolderDialog("Pick Espi Moon Storage Folder", (success, path) =>
                {
                    if (!success) return;
    ...
    public bool DrawOtherPluginState()
    {
        ...
        {
            ImGui.TextColored(ImGuiColors.DalamudRed, "You need to install both Penumbra and Glamourer and keep them up to date to use Espi Moon.");
            return false;
        }
