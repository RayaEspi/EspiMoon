...
using EspiMoon.PlayerData.Data;
...
using CharacterData = EspiMoon.API.Data.CharacterData;
using ObjectKind = EspiMoon.API.Data.Enum.ObjectKind;

namespace EspiMoon.PlayerData.Handlers;
