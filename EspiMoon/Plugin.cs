...
using EspiMoon.Services.CharaData;
using Dalamud.Game;
...
public sealed class Plugin : IDalamudPlugin
{
        ...
        ISigScanner sigScanner)
    {
        ...
        {
            collection.AddSingleton(new WindowSystem("EspiMoon"));
            collection.AddSingleton<FileDialogManager>();
            collection.AddSingleton(new Dalamud.Localization("EspiMoon.Localization.", "", useEmbedded: true));
            ...
            collection.AddSingleton((s) =>
            {
                ...
                httpClient.DefaultRequestHeaders.UserAgent.Add(new ProductInfoHeaderValue("EspiMoon", ver!.Major + "." + ver!.Minor + "." + ver!.Build));
                return httpClient;
            });
