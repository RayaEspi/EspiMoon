...
public sealed class CommandManagerService : IDisposable
{
        ...
        ApiController apiController, MareMediator mediator, MareConfigService mareConfigService)
    {
        ...
        {
            HelpMessage = "Opens the Espi Moon UI" + Environment.NewLine + Environment.NewLine +
    ...
    private void OnCommand(string command, string args)
    {
        ...
        if (string.Equals(splitArgs[0], "toggle", StringComparison.OrdinalIgnoreCase))
        {
            ...
            {
                _mediator.Publish(new NotificationMessage("Mare disconnecting", "Cannot use /toggle while Espi Moon is still disconnecting",
